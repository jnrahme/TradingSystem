...
from ..models import AccountSnapshot, MarketClock, Position, StrategyContext, StrategyOutcome
...
class JsonStrategyStateStore:
    ...
    def save(self, strategy_id: str, snapshot: dict) -> None:
        path = self.root / f"{strategy_id}.json"
        path.write_text(json.dumps(snapshot, indent=2, sort_keys=True))


class StrategyRuntime:
    def __init__(self, ledger: PortfolioLedger, state_store: JsonStrategyStateStore):
        self.ledger = ledger
